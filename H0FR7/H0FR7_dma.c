...
#ifdef _P1
	DMA_MSG_RX_CH_Init(&msgRxDMA[0],DMA1_Channel3);
#endif
#ifdef _P2
	DMA_MSG_RX_CH_Init(&msgRxDMA[1],DMA1_Channel1);
#endif
#ifdef _P3
	DMA_MSG_RX_CH_Init(&msgRxDMA[2],DMA1_Channel4);
#endif
#ifdef _P4
	DMA_MSG_RX_CH_Init(&msgRxDMA[3],DMA1_Channel5);
#endif
#ifdef _P5
	DMA_MSG_RX_CH_Init(&msgRxDMA[4],DMA1_Channel2);
#endif
#ifdef _P6
